...
def add_generation_args(parser):
    ...
    group.add_argument('--test-tokens', default=5, type=int, metavar='N',
                       help='tokens in test sets')
    
    group.add_argument('--hidden-path', default=None, type=str, metavar='PATH',
                       help='path to hidden states')
    group.add_argument('--knn-prob-path', default=None, type=str, metavar='PATH',
                       help='path to knn probs')
    group.add_argument('--report-targets', action='store_true',
                       help='report targets')
...
def add_knn_record_args(parser):
    ...
    group.add_argument('--target-path', default=None, type=str, metavar='PATH',
                       help='path to targets')
    group.add_argument('--index-path', default=None, type=str, metavar='PATH',
